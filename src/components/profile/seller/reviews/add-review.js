    ...
    <>
      <div style={{ width: "40%", marginLeft: "auto", marginRight: "auto" }}>
        <h2 className="mt-5 mb-4" style={{ textAlign: "center" }}>
          <b>Create a review for {seller.username}</b>
        </h2>
        <textarea selected style={{ width: "100%", height: "200px" }} className="rounded ps-2 wd-white-on-bg-color-dark-gray mb-3" placeholder="Description" onChange={(event) => setReview(event.target.value)} />
        <br />
        <div className="row m-0">
          <button className="col btn btn-primary rounded-pill me-1" style={{ backgroundColor: "#105cd4", borderColor: "transparent" }} onClick={createReviewClickHandler}>
            <b>Create review</b>
          </button>
