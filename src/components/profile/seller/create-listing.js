  ...
  return (
    <>
      <div style={{width: "40%", marginLeft: "auto", marginRight: "auto"}}>
        <h2 className="mt-5" style={{ textAlign: "center" }}><b>Create a listing</b></h2>
        ...
        <textarea selected style={{width: "100%"}} className="rounded ps-2 wd-white-on-bg-color-dark-gray" placeholder="Description" onChange={(event) => setDescription(event.target.value)} /><br/>
        <div style={{color: "#C8C8C8"}} className="mb-1 mt-1">Upload a picture of this item</div>
        <div className="row m-0 mb-3">
          <button className="col-4 rounded">Choose File</button>
          <span className="col">No file chosen</span>
        </div>
        <div className="row m-0">
          <button className="col btn btn-primary rounded-pill me-1" style={{ backgroundColor: "#105cd4", borderColor: "transparent" }} onClick={createListingClickHandler}><b>Create listing</b></button>
