...
import { createItemThunk, findRecentListingsThunk, findRecentLikesThunk, findItemsByKeywordThunk, findAllListingsThunk, findAllLikesThunk } from "../services/items/items-thunks";
...
const itemsSlice = createSlice({
  ...
  extraReducers: {
    ...
    // remote api
    [findItemsByKeywordThunk.fulfilled]:
      (state, action) => {
